...
REM
REM Generated by Vivado on Mon Apr 20 12:10:45 +0500 2026
...
echo "xvlog --incr --relax -prj axis_grayscale_vlog.prj"
call xvlog  --incr --relax -prj axis_grayscale_vlog.prj -log xvlog.log
